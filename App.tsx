            ...
            <div className={`flex items-center gap-1.5 sm:gap-3 sm:p-2.5 rounded-[28px] sm:rounded-[40px] border shadow-2xl ${isDarkMode ? 'bg-[#0b0f1a]/95 border-slate-700 shadow-black' : 'bg-white/95 border-slate-300 shadow-blue-900/10'}`}>
              ...
              <div className="flex items-center gap-1.5 p-2.5 sm:px-2 sm:gap-2">
                ...
                <button
                  ...
                  className={`flex items-center justify-center w-12 h-12 sm:px-4 sm:py-3 sm:w-auto sm:h-auto rounded-2xl sm:rounded-xl transition-all duration-300 ${isDarkMode ? 'text-slate-400 hover:text-rose-400' : 'text-slate-500 hover:text-rose-600'}`}
