      ...
      {!isInitialLoading && (
        <div key="bottom-nav-morph-v6" className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[2100] flex flex-col items-center w-full max-w-[400px] sm:max-w-none sm:w-auto pointer-events-none animate-morph-reveal ">
          <div className="pointer-events-auto flex flex-col items-center w-full sm:px-0">
            ...
            <div className={`flex items-center gap-2 py-3 px-3 sm:gap-3 rounded-full border-[1.5px] shadow-2xl ${isDarkMode ? 'bg-[#0b0f1a]/95 border-slate-800 shadow-black' : 'bg-white/95 border-slate-200 shadow-blue-900/10'}`}>
              {/* Left buttons */}
              ...
              <div className="flex items-center gap-2 p-1 sm:px-2 sm:gap-2">
                ...
                <button
                  ...
                  className={`flex items-center justify-center w-[46px] h-[46px] sm:px-4 sm:py-3 sm:w-auto sm:h-auto rounded-full sm:rounded-xl transition-all duration-300 ${isDarkMode ? 'text-slate-400 hover:text-rose-400' : 'text-slate-500 hover:text-rose-600'}`}
