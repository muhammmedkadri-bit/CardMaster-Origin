      ...
      {!isInitialLoading && (
        <div key="bottom-nav-morph-v6" className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[2100] flex flex-col items-center w-full max-w-[380px] sm:max-w-none sm:w-auto pointer-events-none animate-morph-reveal">
          <div className="pointer-events-auto flex flex-col items-center w-full sm:px-0">
            ...
            <div className={`flex items-center gap-0.5 sm:gap-3 sm:p-2.5 rounded-[24px] sm:rounded-[40px] border shadow-2xl ${isDarkMode ? 'bg-[#0b0f1a]/95 border-slate-700 shadow-black' : 'bg-white/95 border-slate-300 shadow-blue-900/10'}`}>
              {/* Left buttons */}
              ...
              <div className="flex items-center gap-0.5 p-1.5 sm:px-2 sm:gap-2">
                ...
                <button onClick={() => setIsDarkMode(!isDarkMode)} className={`flex items-center justify-center w-[42px] h-[42px] sm:px-4 sm:py-3 sm:w-auto sm:h-auto rounded-2xl sm:rounded-xl transition-all duration-300 ${isDarkMode ? 'text-slate-400 hover:text-yellow-400' : 'text-slate-500 hover:text-blue-600'}`} aria-label="Toggle Theme">
                ...
                <button
                  ...
                  className={`flex items-center justify-center w-[42px] h-[42px] sm:px-4 sm:py-3 sm:w-auto sm:h-auto rounded-2xl sm:rounded-xl transition-all duration-300 ${isDarkMode ? 'text-slate-400 hover:text-rose-400' : 'text-slate-500 hover:text-rose-600'}`}
