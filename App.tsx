          ...
          <div className="pointer-events-auto flex flex-col items-center w-full">
            ...
            <div className={`flex items-center gap-2 sm:gap-3 p-2 px-4 sm:p-2.5 rounded-[32px] sm:rounded-[40px] border shadow-2xl overflow-hidden ${isDarkMode ? 'bg-[#0b0f1a]/95 border-slate-800 shadow-black' : 'bg-white/95 border-slate-200 shadow-blue-900/10'}`}>
              <div className="flex items-center px-1.5 sm:px-2 gap-1 sm:gap-2 animate-nav-item-fade [animation-delay:800ms] opacity-0 fill-mode-both">
                <button onClick={() => handleViewChange('dashboard')} className={`flex items-center px-3 sm:px-4 py-3 min-h-[44px] rounded-xl transition-all duration-300 active:scale-95 ${view === 'dashboard' ? (isDarkMode ? 'bg-slate-700 text-white shadow-inner translate-y-[1px]' : 'bg-white text-blue-600 shadow-inner translate-y-[1px]') : (isDarkMode ? 'text-slate-400 hover:text-slate-300' : 'text-slate-500 hover:text-slate-600')}`} aria-label="Dashboard"><LayoutDashboard size={18} className="sm:w-5 sm:h-5" /></button>
                <button onClick={() => handleViewChange('cards')} className={`flex items-center px-3 sm:px-4 py-3 min-h-[44px] rounded-xl transition-all duration-300 active:scale-95 ${view === 'cards' ? (isDarkMode ? 'bg-slate-700 text-white shadow-inner translate-y-[1px]' : 'bg-white text-blue-600 shadow-inner translate-y-[1px]') : (isDarkMode ? 'text-slate-400 hover:text-slate-300' : 'text-slate-500 hover:text-slate-600')}`} aria-label="Cards"><CardIcon size={18} className="sm:w-5 sm:h-5" /></button>
                <button onClick={() => handleViewChange('analysis')} className={`flex items-center px-3 sm:px-4 py-3 min-h-[44px] rounded-xl transition-all duration-300 active:scale-95 ${view === 'analysis' ? (isDarkMode ? 'bg-slate-700 text-white shadow-inner translate-y-[1px]' : 'bg-white text-blue-600 shadow-inner translate-y-[1px]') : (isDarkMode ? 'text-slate-400 hover:text-slate-300' : 'text-slate-500 hover:text-slate-600')}`} aria-label="Analysis"><BarChart3 size={18} className="sm:w-5 sm:h-5" /></button>
              </div>
              ...
              <div className="flex items-center px-1.5 sm:px-2 gap-1 sm:gap-2 animate-nav-item-fade [animation-delay:800ms] opacity-0 fill-mode-both">
                <button onClick={() => handleViewChange('settings')} className={`flex items-center px-3 sm:px-4 py-3 min-h-[44px] rounded-xl transition-all duration-300 active:scale-95 ${view === 'settings' ? (isDarkMode ? 'bg-slate-700 text-white shadow-inner translate-y-[1px]' : 'bg-white text-blue-600 shadow-inner translate-y-[1px]') : (isDarkMode ? 'text-slate-400 hover:text-slate-300' : 'text-slate-500 hover:text-slate-600')}`} aria-label="Settings"><SettingsIcon size={18} className="sm:w-5 sm:h-5" /></button>
