...
const CardModal: React.FC<CardModalProps> = ({ onClose, onSave, initialData, title }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-300">
      <div className="bg-white dark:bg-[#1a1f2e] rounded-[28px] sm:rounded-[32px] w-full max-w-md p-6 sm:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative border border-transparent dark:border-slate-800 animate-in zoom-in-95 duration-300 max-h-[95vh] overflow-y-auto no-scrollbar">
        <button
          onClick={onClose}
