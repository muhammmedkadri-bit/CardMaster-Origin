            ...
            >
                            ...
                            >
                                ...
                                <div
                                    className={`w-[46px] h-[46px] rounded-[16px] flex items-center justify-center transition-all duration-300 ${isActive
                                            ? (isDarkMode
                                                ? 'bg-slate-800 border border-slate-700 shadow-[inset_0_2px_6px_rgba(0,0,0,0.5),0_0_15px_rgba(59,130,246,0.15),0_4px_12px_rgba(0,0,0,0.3)]'
                                                : 'bg-white border border-slate-100 shadow-[inset_0_2px_6px_rgba(0,0,0,0.06),0_0_15px_rgba(37,99,235,0.1),0_4px_12px_rgba(0,0,0,0.08)]')
                                            : 'bg-transparent border-transparent'
                                        }`}
                                >
                                    <span
                                        className={`text-xl font-black tabular-nums transition-all duration-300 ${isActive
                                                ? (isDarkMode ? 'text-white drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]' : 'text-blue-600 drop-shadow-[0_0_8px_rgba(37,99,235,0.3)]')
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
                    <div className="flex flex-col items-center justify-between h-full py-2">
                        <div className={`w-0.5 h-2 rounded-full ${isDarkMode ? 'bg-blue-500/40' : 'bg-blue-600/30'}`} />
                        <div className={`w-0.5 h-2 rounded-full ${isDarkMode ? 'bg-blue-500/40' : 'bg-blue-600/30'}`} />
                    </div>
                </div>
                ...
                {pages.length <= 8 ? pages.map((_, i) => (
                    <div
                        ...
                        className={`transition-all duration-300 rounded-full ${activeIndex === i
                                ? `w-5 h-1.5 ${isDarkMode ? 'bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.6)]' : 'bg-blue-600 shadow-[0_0_10px_rgba(37,99,235,0.4)]'}`
                    ...
                    <div className={`flex items-center gap-2 px-4 py-2 rounded-full border ${isDarkMode
                        ...
                        <span className={`text-sm font-black ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>{activeIndex + 1}</span>
